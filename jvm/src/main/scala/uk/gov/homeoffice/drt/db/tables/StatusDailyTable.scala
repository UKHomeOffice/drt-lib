...
class StatusDailyTable(tag: Tag)
  ...
  def deskRecommendationsUpdatedAt: Rep[Option[Timestamp]] =
    column[Option[Timestamp]]("desk_recommendations_updated_at")
