...
class FeatureGuideSpec extends Specification {
  ...
  val featureGuides = List(
    ...
    FeatureGuide(
      ...
      Some("test2.mov"),
      Some("RTest4"),
      "Here is markdown example test4\r\n\r\n- Some information 1\r\n- Some information 2 \r\n- Some information 3",
      true
    )
  )
  ...
  "Give sequence of FeatureGuide Object I get Json seq" >> {
    "Then I should be able to serialise and de-serialise it" >> {
      ...
      val featureGuidesString =
        """[{"id":[1],"uploadTime":1686066599088,"fileName":["test1"],"title":["Test1"],"markdownContent":"Here is markdown example","published":true},{"id":[2],"uploadTime":1686066891940,"fileName":["test2"],"title":["Test3"],"markdownContent":"Here is markdown example","published":true}]"""
