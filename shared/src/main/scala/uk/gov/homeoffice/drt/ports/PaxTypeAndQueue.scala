...
object PaxTypesAndQueues {
  ...
  val visaNationalToEGate: PaxTypeAndQueue = PaxTypeAndQueue(PaxTypes.VisaNational, Queues.EGate)
  val nonVisaNationalToDesk: PaxTypeAndQueue = PaxTypeAndQueue(PaxTypes.NonVisaNational, Queues.NonEeaDesk)
  val nonVisaNationalToEGate: PaxTypeAndQueue = PaxTypeAndQueue(PaxTypes.NonVisaNational, Queues.EGate)
